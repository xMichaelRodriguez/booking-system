...
export class migrations1675745175386 implements MigrationInterface {
  name = 'migrations1675745175386';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "services" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(100) NOT NULL, "description" varchar(500) NOT NULL, "price" decimal(10,2) NOT NULL DEFAULT (0), CONSTRAINT "UQ_019d74f7abcdcb5a0113010cb03" UNIQUE ("name"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "status" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(12) NOT NULL, CONSTRAINT "UQ_95ff138b88fdd8a7c9ebdb97a32" UNIQUE ("name"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "username" varchar NOT NULL, "email" text NOT NULL, "password" text, "is_active" boolean NOT NULL DEFAULT (0), "is_google_account" boolean NOT NULL DEFAULT (0), "activation_token" varchar, "reset_password_token" varchar, "role_id" integer, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_89a1c9adfee558c580dd8a2b6aa" UNIQUE ("activation_token"), CONSTRAINT "UQ_ee6419219542371563e0592db51" UNIQUE ("reset_password_token"))`,
    );
    await queryRunner.query(
